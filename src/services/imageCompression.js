...
export async function uploadToServer(file, token) {
...
export async function handleImageUpload(imageFile, token) {
    ...
    try {
        ...
        const resp = await uploadToServer(compressedFile, token); // write your own logic
