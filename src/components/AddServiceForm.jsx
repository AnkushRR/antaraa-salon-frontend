...
export default function AddServiceForm(props){
    ...
    return (
        <div className='flex flex-wrap w-screen justify-center'>
            ...
            <div className='bg-white shadow-lg mx-1 rounded px-4 pt-6 pb-5 mb-4 mt-5 max-w-full overflow-auto'>
            ...
            <div className='bg-white shadow-lg rounded px-8 pt-6 pb-1 mb-4 mt-5 sm:max-w-md max-w-sm'>
                ...
                <FormDynamicInput label="Products Included" selectList={addedProducts}
